...
namespace Microsoft.MixedReality.Toolkit.UI
{
    ...
    public class AppBar : MonoBehaviour
    {
        ...
        [Tooltip("Should the AppBar have an ExplodedView button")]
        [SerializeField]
        private bool useExplodedView = true;

        /// <summary>
        /// Should the AppBar have an ExplodedView button
        /// </summary>
        public bool UseExplodedView
        {
            get { return useExplodedView; }
            set { useExplodedView = value; }
        }
        ...
        [Tooltip("The ExplodedView button texture")]
        [SerializeField]
        private Texture explodedViewIcon = null;

        /// <summary>
        /// The adjust button texture
        /// </summary>
        public Texture ExplodedViewIcon
        {
            get => ExplodedViewIcon;
            set => ExplodedViewIcon = value;
        }
            ...
            switch (buttonType)
            {
                ...
                case ButtonTypeEnum.Adjust:
                    if (!UseAdjust)
                        return false;
                    break;
                case ButtonTypeEnum.ExplodedView:
                    if (!UseExplodedView)
                        return false;
                    break;
            }
        ...
        public void GetButtonTextAndIconFromType(ButtonTypeEnum type, out string buttonText, out Texture buttonIcon, out int displayOrder)
        {
            switch (type)
            {
                ...
                case ButtonTypeEnum.Hide:
                    buttonText = "Inklappen";
                    buttonIcon = HideIcon;
                    displayOrder = 1;
                    break;

                case ButtonTypeEnum.Adjust:
                    buttonText = "Manipuleren";
